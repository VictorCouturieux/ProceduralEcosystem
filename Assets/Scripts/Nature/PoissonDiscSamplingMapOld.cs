...
public static class PoissonDiscSamplingMapOld {

	public static List<Vector3> GeneratePoints(float radius, Vector3 sampleRegionSize, Vector3 sampleRegionCenter, int numSamplesBeforeRejection = 30) {
